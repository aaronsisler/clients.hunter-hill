  ...
  <div className={styles.firstStepContainer}>
    ...
    <div className={styles.firstStepContainer__content}>
      ...
      <p>
        ...
        and we&apos;re here to help. Our team understands the unique needs of
        each person and the desire to remain as safely independent as
        possible.&nbsp;
        <Hyperlink
      ...
      <p>
        Perhaps you aren&apos;t even ready to start the journey right now.
        That&apos;s okay. The more you gather information and learn about the
        opportunities available to you and your loved one, the better decision
        you&apos;ll be able to make in the future.
      </p>
      <p>
        We understand that this decision is important, and it&apos;s not always
        easy to make the choice. The journey towards senior living doesn&apos;t
        happen overnight. It&apos;s a process that we will gladly go through
        with you, answering any questions that you may have.&nbsp;
        <Hyperlink
          href="/faqs"
