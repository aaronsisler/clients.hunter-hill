  ...
  <div className={styles.dailyLifeContainer}>
    ...
    <div className={styles.dailyLifeContainer__content}>
      ...
      <div className={styles.dailyLifeContainer__topic}>
        ...
        <p className={styles.dailyLifeContainer__topicContent}>
          A great meal is one of life&apos;s simple pleasures. At Hunter Hill,
          we believe dining well is part of living well. Your loved one will
          enjoy restaurant-style dining with chef-prepared meals. Each day
